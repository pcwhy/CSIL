...
%             gradientMasks{fingerprintLayerIdx,3} = {dlarray([zeros(18,18); ones(newClassesNum,18)])};
%             gradientMasks{fingerprintLayerIdx+1,3} = {dlarray([zeros(18,1); ones(newClassesNum,1)])};
